...
void main() {
    ...
    // Wobbling effect
    float wobbleAmount = 0.2; // amplitude of the wobble
    newPosition.x += wobbleAmount * sin(5.0 * position.x + uTime);
    newPosition.y += wobbleAmount * sin(5.0 * position.y + uTime);
    newPosition.z += wobbleAmount * sin(5.0 * position.z + uTime);
